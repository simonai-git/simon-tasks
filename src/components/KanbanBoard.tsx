...
export default function KanbanBoard() {
  ...
  return (
    <div className="p-3 sm:p-6 lg:p-8 max-w-[1600px] mx-auto">
      ...
      >
        <div className="flex gap-3 sm:gap-4 overflow-x-auto sm:overflow-hidden pb-4 -mx-3 px-3 sm:mx-0 sm:px-0 snap-x snap-mandatory sm:snap-none scrollbar-hide w-full">
